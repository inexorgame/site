...
export function resolveSidebarItems (page, route, site, localePath) {
    ...
    const sidebarConfig = Object.assign({}, localeConfig.sidebar || themeConfig.sidebar)
...
export function createEditLink(repo, docsRepo, docsDir, docsBranch, path) {
    ...
    const base = outboundRE.test(docsRepo) ? docsRepo : `https://github.com/${docsRepo}/edit/master/`
